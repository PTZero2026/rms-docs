...
- **Dữ liệu mẫu:**
  - Đợt kêu gọi `KG-2026-01` đã `CLOSED`, gán bộ tiêu chí `PROPOSAL_REVIEW` gồm 3 tiêu chí
...
|----|-------------|----------------|----------------|------------------|------|
| TC-01 | AC-01 | DT-A `SUBMITTED`, HĐ HD-XD-01 đã có thành viên, đợt đã gán bộ tiêu chí | Chuyên viên tạo `EvaluationRound` cho DT-A | Đợt tạo `COLLECTING_SCORES`; DT-A → `UNDER_REVIEW`; chủ nhiệm nhận thông báo; có audit | Happy |
...
| TC-12 | AC-01 (BR-02) | DT thuộc đợt kêu gọi **chưa** gán `reviewCriteriaSetId` | Chuyên viên tạo `EvaluationRound` | Bị chặn; thông báo "đợt chưa gán bộ tiêu chí xét duyệt" | Biên/Lỗi |
...
- [ ] F02: bộ tiêu chí `reviewCriteriaSetId` của đợt vẫn áp dụng đúng khi tạo `EvaluationRound`.
