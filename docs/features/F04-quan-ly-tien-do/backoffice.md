...
| Giao đề tài (`APPROVED → IN_PROGRESS`) | `PROGRESS.ASSIGN_PROJECT` | ✓ | – |
...
Ghi `AuditLog` cho: giao đề tài, lập/sửa kỳ báo cáo, duyệt báo cáo, yêu cầu chỉnh sửa, tạm dừng/tiếp
tục (kèm `reason`), chuyển chờ nghiệm thu, mở lại báo cáo `PASSED`. Chuyên viên/quản trị xem được nhật ký theo
phạm vi dữ liệu.
