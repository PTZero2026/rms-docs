...
Ai thao tác feature này, vào từ đâu, và mỗi vai trò thấy được gì.

- **Người dùng cuối:** (mô tả đối tượng người dùng cuối — bổ sung khi có).
- **Vai trò quản trị:** (mô tả vai trò quản trị dùng feature này — bổ sung khi có).
...
Quyền nguyên tử dạng `MODULE.ACTION` (data-model §4.1). UI chỉ ẩn/hiện theo quyền.
...
hành động hàng loạt, quy trình duyệt nhiều cấp (nếu có).
